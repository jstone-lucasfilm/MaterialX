...
/// @class ConstantElisionRefactor
/// Removes constant nodes by moving their values downstream.
class MX_GENSHADER_API ConstantElisionRefactor : public ShaderGraphRefactor
{
  public:
...
/// @class DotElisionRefactor
/// Removes dot nodes with filename-typed inputs to prevent extra samplers.
class MX_GENSHADER_API DotElisionRefactor : public ShaderGraphRefactor
{
  public:
    const string& getName() const override;
    size_t execute(ShaderGraph& graph, GenContext& context) override;
